...
$PR_BLUE$PR_ULCORNER$PR_HBAR$PR_GREY($PR_BLUE%(!.%SROOT%s.%n)$PR_WHITE@$PR_LIGHT_YELLOW%m$PR_GREY->$PR_GREY\
$PR_GREEN%$PR_PWDLEN<...<%~%<<\
$PR_GREY)`rvm_prompt_info || rbenv_prompt_info`$PR_GREY$PR_HBAR$PR_HBAR${(e)PR_FILLBAR}$PR_BLUE(\
$PR_GREY:%l\
$PR_BLUE)$PR_URCORNER\

$PR_BLUE$PR_LLCORNER$PR_HBAR$PR_GREY(\
$PR_YELLOW%D{%H:%M:%S}\
...
>$PR_NO_COLOUR '
    ...
    RPROMPT=' $return_code$PR_BLUE$PR_HBAR\
($PR_YELLOW%D{%a,%b%d}$PR_BLUE)$PR_LRCORNER$PR_NO_COLOUR'
